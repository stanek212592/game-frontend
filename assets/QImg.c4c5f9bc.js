...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:on,depthTest:!1,depthWrite:!1})}function ka(){return new hn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Es(),fragmentShader:`
		...
		`,blending:on,depthTest:!1,depthWrite:!1})}function Wa(){return new hn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Es(),fragmentShader:`
